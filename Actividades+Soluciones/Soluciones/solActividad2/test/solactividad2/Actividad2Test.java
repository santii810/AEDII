...
public class Actividad2Test {
	...
	private static final ArbolBinario<Integer> hoja1 = new EnlazadoArbolBinario<>(new Integer(3), vacio, vacio);
	private static final ArbolBinario<Integer> hoja11 = new EnlazadoArbolBinario<>(new Integer(3), vacio, vacio);
	private static final ArbolBinario<Integer> hoja2 = new EnlazadoArbolBinario<>(new Integer(5), vacio, vacio);
	private static final ArbolBinario<Integer> hoja3 = new EnlazadoArbolBinario<>(new Integer(7), vacio, vacio);
	private static final ArbolBinario<Integer> nodo1 = new EnlazadoArbolBinario<>(new Integer(11), hoja1, hoja2); 
	private static final ArbolBinario<Integer> nodo2 = new EnlazadoArbolBinario<>(new Integer(3), hoja1, hoja2);
	private static final ArbolBinario<Integer> raiz = new EnlazadoArbolBinario<>(new Integer(7), nodo1, hoja3);
	private static final ArbolBinario<Integer> selec = new EnlazadoArbolBinario<>(new Integer(3), nodo2, hoja3);
	private static final ArbolBinario<Integer> degen = new EnlazadoArbolBinario<>(new Integer(1), new EnlazadoArbolBinario<Integer>(new Integer(13), vacio, hoja3), vacio);
	private static final ArbolBinario<Integer> nodoSinHojas = new EnlazadoArbolBinario<>(new Integer(11), vacio, vacio);
	private static final ArbolBinario<Integer> raizSinHojas = new EnlazadoArbolBinario<>(new Integer(7), nodoSinHojas, vacio);
	private static final ArbolBinario<Integer> raizHasta1 = new EnlazadoArbolBinario<>(new Integer(7), nodoSinHojas, hoja3);
